...
@section('css')
    ...
    {{-- Page title --}}
    <title>Products details | Upswale.com</title>
                    ...
                    <section class="mb-4 mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <button type="button" class="btn btn-outline-warning btn-md mr-1 mb-2"><i class="fas fa-shopping-cart pr-2"></i>Add to cart </button>
                                <hr>
