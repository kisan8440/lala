...
@section('css')
    ...
    {{-- Page title --}}
    <title>{{ $itemDetails->itemname ?? 'Item details' }}</title>
            ...
            <div class="row">
                <div class="container pt-1 pb-1 custom-breadcumb">
                    ...
                    @if ($itemDetails->oemname)
                        ...
                        @php
                            $url = $url .''. $joinQuery . 'oem=' . $itemDetails->oemcode;
                        @endphp
                        ...
                        <div class="container mt-3">
                            ...
                            @foreach ($supportNavDesc as $nav)
                                ...
                                @if ($nav->descriptioncode != '')
                                    @include('support.templates.items_nav.'.$nav->descriptioncode)
                                @endif
