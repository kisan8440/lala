<div class="row mb-2" id="{{ $nav->descriptioncode }}">
    <div class="col-12 specs-area">
        ...
        <div class="row">
            ...
            @forelse ($itemDetails['Supprted_item'] as $prodBom)
                ...
                {{-- ------------- --}}
                @if (!in_array($prodBom->csl , explode(',', request()->input('bom-r'))))
                <div class="col-sm-12 mb-2 bom-outer bom-outer-{{ $prodBom->csl }}">
                    <div class="border border-custom-light p-2 view overlay rounded z-depth-1 gallery-item">
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-4 col-lg-2 bom-image">
                                <a class="" href="{{ route('brands.view', $prodBom->csl) }}">
