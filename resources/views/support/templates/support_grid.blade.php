        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12">
                        <h6>
                            Showing ({{ $support->firstItem() ?? '0' }} - {{ $support->lastItem() ?? '0' }}) of total {{ $support->total() }} items.
                        </h6>
                        <hr>
                    </div>
                </div>
            ...
            @forelse ($support as $item)
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="product-outer theme-block box-hover-effect parent p-3">
                        <a href="{{ route('support.view', $item->csl) }}">
                                ...
                                <?php                                  							
                                    ...
                                    if($path != ''){
                                        if(     strpos($path, '.jpg') > -1 
                                            ...
                                            if($data === false){
                                                $path = asset('public/assets/images/support/img_404.jpg');
                                                $data = file_get_contents($path);
                                            }                                        
                                                
                                            $base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
                                        }else{
                                            $base64 = asset('public/assets/images/support/img_404.jpg');
                                        }
                                    }else{
                                        $base64 = asset('public/assets/images/support/img_404.jpg');
                                    }
